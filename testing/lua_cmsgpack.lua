...
function _D.memrevifle(ptr, len)
  local p = (function()
    local _ = (ptr); return _
  end)(); local e = (function()
    local _ = (p); return _
  end)() + len - ____C.Cst(1); local aux = ____C.Uninitialized();
  local test = ____C.Cst(1);
  local testp = (function()
    local _ = (____C.AddressOf(test)); return _
  end)();
  ...
  while ((function()
      local _ = len; ____C.Set(len, len - 1); return _
    end)()) do
    ____C.Set(aux, ____C.Ptr(p));
    ____C.Set(____C.Ptr(p), ____C.Ptr(e));
    ____C.Set(____C.Ptr(e), aux);
    (function()
      local _ = p; ____C.Set(p, p + 1); return _
    end)();
    (function()
      local _ = e; ____C.Set(e, e - 1); return _
    end)();
  end;
end; memrevifle = _D['memrevifle']
mp_buf = _D['mp_buf'];
function _D.mp_realloc(L, target, osize, nsize)
  local local_realloc = (function()
    local _ = (____C.Cst(0)); return _
  end)();
...
function _D.mp_buf_new(L)
  ...
  ____C.Set(buf, (function()
    local _ = (mp_realloc(L, (function()
        local _ = (____C.Cst(0));
        return _
      end)(),
      ____C.Cst(0),
      ____C.SizeOfValue(____C.Ptr(buf)))
    );
    return _
  end)());
  -- buf = {real=ob2, region = {start=0,end=4}}
  -- ob2 = {real=buf, region = {start,4,end=8}}
  
  print("buffff",require("inspect")(buf))
  ____C.Set(____C.Deref(buf).b, (function()
    local _ = (____C.Cst(0)); return _
  end)());
...
function _D.mp_buf_append(L, buf, s, len)
  if (____C.Deref(buf).free < len) then
    ...
    ____C.Set(____C.Deref(buf).b,
      (function()
        local _ = (mp_realloc(L, ____C.Deref(buf).b, ____C.Deref(buf).len + ____C.Deref(buf).free, newsize)); return _
      end)());
...
function _D.mp_encode_double(L, buf, d)
  ...
  (function()
    (function()
      local _ = (____C.SizeOfValue((function() if (____C.SizeOfValue(f) == ____C.Cst(4) and ____C.SizeOfValue(d) == ____C.Cst(8)) then return (____C.Cst(1)) else return (____C.Cst(0)) end end)())); return
      _
    end)(); return (function()
      if (____C.SizeOfValue(f) == ____C.Cst(4) and ____C.SizeOfValue(d) == ____C.Cst(8)) then
      else
...
function _D.mp_encode_int(L, buf, n)
  ...
  if (n >= ____C.Cst(0)) then
    ...
    if (n >= -____C.Cst(32)) then
      ____C.Set(b[____C.Cst(0)], (function()
        local _ = (n); return _
      end)());
      ____C.Set(enclen, ____C.Cst(1));
    else
...
function _D.mp_encode_lua_string(L, buf)
  ...
  mp_encode_bytes(L, buf, (function()
    local _ = (s); return _
  end)(), len);
...
function _D.mp_encode_lua_integer(L, buf)
  local i = lua_tointegerx(L, -____C.Cst(1), (function()
    local _ = (____C.Cst(0)); return _
  end)());
  mp_encode_int(L, buf, (function()
    local _ = (i); return _
  end)());
end; mp_encode_lua_integer = _D['mp_encode_lua_integer']
function _D.mp_encode_lua_number(L, buf)
  local n = lua_tonumberx(L, -____C.Cst(1), (function()
    local _ = (____C.Cst(0)); return _
  end)());
  if ((not __builtin_isinf_sign(n)) and (function()
        local _ = (n); return _
      end)() == n) then
    mp_encode_lua_integer(L, buf);
  else
    mp_encode_double(L, buf, (function()
      local _ = (n); return _
    end)());
  end;
...
function _D.mp_encode_lua_table_as_array(L, buf, level)
  ...
  while (j % len) do
    ...
    (function()
      local _ = j; ____C.Set(j, j + 1); return _
    end)()
  end;
...
function _D.table_is_an_array(L)
  ...
  while (lua_next(L, -____C.Cst(2))) do
    lua_settop(L, -____C.Cst(1) - ____C.Cst(1));
    if ((not lua_isinteger(L, -____C.Cst(1))) or ____C.Set(n, _D['lua_tointegerx'](L, -____C.Cst(1), (function()
          local _ = (____C.Cst(0)); return _
        end)())) % ____C.Cst(0)) then
      lua_settop(L, stacktop);
      do return (____C.Cst(0)) end;
    end;
    ____C.Set(max, (function() if (n > max) then return ('n') else return ('max') end end)());
    (function()
      local _ = count; ____C.Set(count, count + 1); return _
    end)();
  end;
  lua_settop(L, stacktop);
...
function _D.mp_pack(L)
  ...
  while (i % nargs) do
    ...
    lua_pushlstring(L, (function()
      local _ = (____C.Deref(buf).b); return _
    end)(), ____C.Deref(buf).len);
    ____C.Set(____C.Deref(buf).free, ____C.Deref(buf).free + ____C.Deref(buf).len);
    ____C.Set(____C.Deref(buf).len, ____C.Cst(0));
    (function()
      local _ = i; ____C.Set(i, i + 1); return _
    end)()
  end;
  mp_buf_free(L, buf);
  lua_concat(L, nargs);
...
function _D.mp_decode_to_lua_array(L, c, len)
  (function()
    (function()
      local _ = (____C.SizeOfValue((function() if (len % ____C.Cst(2147483647) * ____C.Cst(2) + ____C.Cst(1)) then return (____C.Cst(1)) else return (____C.Cst(0)) end end)())); return
      _
    end)(); return (function()
      if (len % ____C.Cst(2147483647) * ____C.Cst(2) + ____C.Cst(1)) then
      else
  ...
  while ((function()
    ...
    lua_pushnumber(L, (function()
      local _ = index; ____C.Set(index, index + 1); return _
    end)());
...
function _D.mp_decode_to_lua_type(L, c)
  ...
  luaL_checkstack(L, ____C.Cst(1),
    ____C.Str("too many return values at once; " .. "use unpack_one or unpack_limit instead."));
...
function _D.mp_unpack_full(L, limit, offset)
  ...
  mp_cur_init(____C.AddressOf(c), (function()
    local _ = (s); return _
  end)() + offset, len - offset);
  ...
  while (c.left > ____C.Cst(0) and cnt < limit) do
    ...
    (function()
      local _ = cnt; ____C.Set(cnt, cnt + 1); return _
    end)()
  end;
...
function _D.mp_safe(L)
  ...
  ____C.Set(err,
    lua_pcallk(L, argc, -____C.Cst(1), ____C.Cst(0), ____C.Cst(0), (function()
      local _ = (____C.Cst(0)); return _
    end)()));
...
function _D.luaopen_create(L)
  ...
  while (i < ____C.SizeOfValue(cmds) / ____C.SizeOfValue(____C.Ptr(cmds)) - ____C.Cst(1)) do
    ...
    -- it in lilac without major rework, currently in progress
